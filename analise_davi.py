...
jaccard_results = pd.read_csv("2023-01-20_jaccard-results.csv")
...
"""
model = smf.mixedlm("JAC_Product ~ Superpixel_amount",
                    data=jaccard_results, groups=jaccard_results["Image"])
